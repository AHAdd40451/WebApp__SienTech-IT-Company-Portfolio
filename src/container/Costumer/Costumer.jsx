            ...
            <Box sx={styles.titleBox}>
              ...
              >
                <h2 className="head-text">
                  ...
                  <span> what you like to expect</span>
                </h2>

                <Text as="p" className="">
                  We offer a risk-free trial period of up to two weeks. You will
                  only have to pay if you are happy with the developer and wish
                  to continue. If you are unsatisfied, we’ll refund payment or
